...
LANGUAGE_PREF_FILE = "language_pref.json"
...
def load_language_preference():
    """Load the last selected language from file"""
    try:
...
class LoginGUI(tk.Frame):
    ...
    def on_language_select(self, event=None):
        ...
        new_lang = language_map.get(selected, "en")
    ...
    def do_login(self):
        ...
        placeholder_passwords = ["Password", "Mot de passe", "Contraseña"]
        
        if (not username or not password or
                username in placeholder_usernames or
